...
import {
  marketplaceGetWallet,
  IPOJOWallet,
  toWalletPojo,
  loadTransactionsByToken,
  syncTransactions, IWallet
} from "./../common/_wallet";
...
export class Purchase extends SessionComponent<PurchaseProps, PurchaseState> {
  ...
  render() {
    ...
    let currOwn_img = this.props.nftForm.sellerInfo?.image;
...
export async function getServerSideProps(context: any) {
  ...
  // get wallet of user
  const [ { u, wallet }, activity ] = await Promise.all([
    marketplaceGetWallet(sessionUser),
    loadTransactionsByToken(nft._id)
  ]);
