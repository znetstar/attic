        ...
        <form onSubmit={(e) => { updateAssetForm(); e.preventDefault(); }}>
           <div>
              <FormControl className={'form-control'}>
                <TextField onChange={(e) => { onFormChange(e.target.name, e.target.value) }} value={nftForm.name}  required={true} className={'form-input'}  variant={"filled"} name={"name"} label="Title" />
              </FormControl>
            </div>
            <div>
              <FormControl className={'form-control'}>
