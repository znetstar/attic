    ...
    docker.withRegistry('https://981470858920.dkr.ecr.us-east-1.amazonaws.com', 'ecr:us-east-1:thirdact') {
      withCredentials([[
        ...
        secretKeyVariable: 'AWS_SECRET_ACCESS_KEY'
          ...
          sh "docker build --build-arg AWS_ACCESS_KEY_ID='${AWS_ACCESS_KEY_ID}' --build-arg AWS_SECRET_ACCESS_KEY='${AWS_SECRET_ACCESS_KEY}' --build-arg NODE_OPTIONS=--max_old_space_size=78643 -t 981470858920.dkr.ecr.us-east-1.amazonaws.com/thirdact-attic:\$(bash get-version.sh) ./"
          sh "docker tag 981470858920.dkr.ecr.us-east-1.amazonaws.com/thirdact-attic:\$(bash get-version.sh) 981470858920.dkr.ecr.us-east-1.amazonaws.com/thirdact-attic:latest"
          sh "docker push 981470858920.dkr.ecr.us-east-1.amazonaws.com/thirdact-attic:\$(bash get-version.sh); docker push  981470858920.dkr.ecr.us-east-1.amazonaws.com/thirdact-attic:latest"
